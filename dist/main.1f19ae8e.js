...
},{}],"../node_modules/wretch/dist/mix.js":[function(require,module,exports) {
"use strict";
...
exports.mix = mix;
},{}],"../node_modules/wretch/dist/config.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
var _default = config;
exports.default = _default;
},{}],"../node_modules/wretch/dist/perfs.js":[function(require,module,exports) {
"use strict";
...
var perfs = {
  ...
  observe: function (name, callback) {
    ...
    var _performance = _config.default.polyfill("performance", {
      doThrow: false
    });

    var _observer = _config.default.polyfill("PerformanceObserver", {
      doThrow: false
    });
...
var _default = perfs;
exports.default = _default;
},{"./config":"../node_modules/wretch/dist/config.js"}],"../node_modules/wretch/dist/middleware.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.middlewareHelper = void 0;
...
},{}],"../node_modules/wretch/dist/resolver.js":[function(require,module,exports) {
"use strict";
...
var _perfs = _interopRequireDefault(require("./perfs"));
...
var resolver = function (wretcher) {
  var url = wretcher._url,
      catchers = wretcher._catchers,
      resolvers = wretcher._resolvers,
      middlewares = wretcher._middlewares,
      opts = wretcher._options;
  var finalOptions = (0, _mix.mix)(_config.default.defaults, opts);

  var fetchController = _config.default.polyfill("AbortController", {
    doThrow: false,
    instance: true
  });
  ...
  var fetchRequest = (0, _middleware.middlewareHelper)(middlewares)(_config.default.polyfill("fetch"))(url, finalOptions); // Throws on an http error

  var throwingPromise = fetchRequest.then(function (response) {
    if (!response.ok) {
      return response[_config.default.errorType || "text"]().then(function (msg) {
        // Enhances the error object
        var err = new Error(msg);
        err[_config.default.errorType || "text"] = msg;
  ...
  var responseChain = {
    ...
    perfs: function (cb) {
      fetchRequest.then(function (res) {
        return _perfs.default.observe(res.url, cb);
      });
...
},{"./mix":"../node_modules/wretch/dist/mix.js","./config":"../node_modules/wretch/dist/config.js","./perfs":"../node_modules/wretch/dist/perfs.js","./middleware":"../node_modules/wretch/dist/middleware.js"}],"../node_modules/wretch/dist/wretcher.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Wretcher = void 0;
...
function () {
  ...
  Wretcher.prototype.defaults = function (options, mixin) {
    ...
    _config.default.defaults = mixin ? (0, _mix.mix)(_config.default.defaults, options) : options;
    return this;
  };
  /**
  ...
  Wretcher.prototype.errorType = function (method) {
    _config.default.errorType = method;
    return this;
  };
  /**
  ...
  Wretcher.prototype.polyfills = function (polyfills) {
    _config.default.polyfills = __assign({}, _config.default.polyfills, polyfills);
    return this;
  };
  /**
  ...
  Wretcher.prototype.options = function (options, mixin) {
    ...
    return this.selfFactory({
      options: mixin ? (0, _mix.mix)(this._options, options) : options
    });
  };
  /**
  ...
  Wretcher.prototype.headers = function (headerValues) {
    return this.selfFactory({
      options: (0, _mix.mix)(this._options, {
  ...
  Wretcher.prototype.method = function (method, options, body) {
    ...
    return (0, _resolver.resolver)(deferredWretcher.options(__assign({}, options, {
      method: method
    })));
  };
  /**
...
var appendQueryParams = function (url, qp, replace) {
  ...
  if (typeof qp === "string") {
    ...
    var usp = _config.default.polyfill("URLSearchParams", {
      instance: true
    });
...
function convertFormData(formObject) {
  var formData = _config.default.polyfill("FormData", {
    instance: true
  });
...
},{"./mix":"../node_modules/wretch/dist/mix.js","./config":"../node_modules/wretch/dist/config.js","./resolver":"../node_modules/wretch/dist/resolver.js"}],"../node_modules/wretch/dist/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "Wretcher", {
  enumerable: true,
  get: function () {
    return _wretcher.Wretcher;
  }
});
exports.default = void 0;

var _wretcher = require("./wretcher");

var factory = _wretcher.Wretcher.factory;
factory["default"] = _wretcher.Wretcher.factory;
...
exports.default = _default;
},{"./wretcher":"../node_modules/wretch/dist/wretcher.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function beginLoad() {
  ...
  api.url("projects/".concat(Constants.projectID, "/tasks?opt_fields=name,custom_fields&opt_expand=custom_fields")).get().json(function (result) {
...
function taskToSituation(task) {
  ...
  try {
    for (var _iterator = task.custom_fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var field = _step.value;

      if (field.name.indexOf("jg_") === 0) {
        var name = field.name.slice(3);
...
var _default = {
  ...
  methods: {
    storeAuthToken: function storeAuthToken() {
...
exports.default = _default;
        var $abafc8 = exports.default || module.exports;
      
      if (typeof $abafc8 === 'function') {
        $abafc8 = $abafc8.options;
      }
    
        /* template */
        Object.assign($abafc8, (function () {
          var render = function() {
  var _vm = this
    ...
    _c("input", {
      ...
      on: {
        input: function($event) {
          ...
          _vm.authToken = $event.target.value
        }
      }
    }),
    _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$abafc8', $abafc8);
          } else {
            api.reload('$abafc8', $abafc8);
          }
        }
...
},{"wretch":"../node_modules/wretch/dist/index.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App":"App.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
